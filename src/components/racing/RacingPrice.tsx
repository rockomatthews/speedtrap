...
export function RacingPrice({ durationMinutes, simCount = 1 }: { durationMinutes: number; simCount?: number }) {
  ...
  const price = applyRacingDiscount(base, discount);
  ...
  return <Box component="span">
    ...
    {price.percent > 0 && <Box component="span" sx={{ display: 'block', fontSize: 13, lineHeight: 1.4, mt: 1 }}>{price.percent}% off standard racing · excludes member pricing</Box>}
  </Box>;
}
