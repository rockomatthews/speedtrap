...
const envSchema = z.object({
  ...
  VMS_MEMBERSHIP_ID: z.coerce.number().int().positive().optional(),
  VMS_BOOKING_EVENT_ACTIVITY: z.string().min(1).optional(),
...
function readEnv(): Env {
  return envSchema.parse({
    ...
    VMS_MEMBERSHIP_ID: process.env.VMS_MEMBERSHIP_ID,
    VMS_BOOKING_EVENT_ACTIVITY: process.env.VMS_BOOKING_EVENT_ACTIVITY,
