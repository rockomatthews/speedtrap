...
import { BUSINESS_HOURS_SUMMARY, SITE_CONTACT } from '@/lib/site-info';
            ...
            <Grid container spacing={3} sx={{ width: '100%', maxWidth: 1180, mx: 'auto' }}>
              ...
              <Grid size={{ xs: 12, md: 4 }}>
                <Stack spacing={0.75}>
                  ...
                  <Typography color="text.secondary">{SITE_CONTACT.address}</Typography>
                  <Typography color="text.secondary">{SITE_CONTACT.phone}</Typography>
                  <Typography color="text.secondary">Hours: {BUSINESS_HOURS_SUMMARY}</Typography>
                </Stack>
              </Grid>
              <Grid size={{ xs: 12, md: 4 }}>
                <Stack
